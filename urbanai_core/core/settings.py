"""
UrbanAI AI - Core Settings Module
...
class KafkaSettings(BaseSettings):
    ...
    consumer_group: str = Field(default="urbanai_core")
...
class DatabaseSettings(BaseSettings):
    ...
    name: str = Field(default="urbanai_core")
...
class Settings(BaseSettings):
    ...
    service_name: str = Field(default="urbanai_core")
