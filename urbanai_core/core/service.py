"""
UrbanAI AI - Base Service Module
...
from urbanai_core.core.settings import Settings, get_settings


class BaseService(ABC):
    """
    Abstract base class for all UrbanAI microservices.
    ...
    def _create_app(self) -> FastAPI:
        ...
        app = FastAPI(
            title=f"UrbanAI - {self.service_name}",
            version=self.version,
            lifespan=lifespan,
        )
