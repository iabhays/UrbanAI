...
class PersonDetector:
    ...
    def __init__(
        ...
        print(f"Initializing PersonDetector on device: {self.device}")
        ...
        try:
            ...
            if self.device == 'cuda':
                try:
                    ...
                    print(f"Failed to move model to CUDA: {e}, using CPU")
                    self.device = 'cpu'
            
            print(f"Successfully loaded YOLO model: {self.model_path}")
            return model
    ...
    def detect(
        ...
        try:
            ...
            print(f"Frame {frame_id}: Detected {len(detections)} persons")
